...
<head>
    ...
    <!-- Custom CSS file containing additional styles and responsive breakpoints -->
...
<body>
    ...
    <div class="container pb-5">
        ...
        <!-- Page Header - Displays the inventory dashboard title, status, and add new vehicle button -->
        <div class="container-fluid py-4">

            <div class="p-3 rounded-4 shadow-sm bg-white">
                <div class="row align-items-center justify-content-between g-3">
                    <div class="col-md-6">
                        <h2 class="fw-bold fs-4">Inventory Dashboard</h2>
                        <p class="text-secondary mb-0 small">
                            <i class="ph-fill ph-check-circle text-success me-1"></i> Active • Tracking vehicle data
                        </p>
                    </div>
                    <!-- <div class="col-md-12 d-flex justify-content-center" onclick="openModal('dealModal')">
                        <button class="btn btn-primary rounded-pill px-4 py-2">
                            <i class="ph-bold ph-plus me-1"></i> Add New Vehicle
                        </button>
                    </div> -->
                </div>
            </div>
        ...
        <!-- Filters Section - Includes stock summary badges and filter button to open the filter modal -->
        <!-- STOCK SUMMARY + FILTER BUTTON -->
        <div class="d-flex flex-column flex-md-row justify-content-between align-items-center mb-4 gap-2">

            <!-- Stock Summary Badges -->
            <div class="d-flex flex-column flex-md-row align-items-center justify-content-start gap-2">
                <span class="small text-muted fw-bold me-2">Stock Summary:</span>
                <div class="d-flex flex-wrap gap-2">
                    <span class="badge bg-dark">
                        Total: <span class="fw-bolder">17</span>
                    </span>
                    <span class="badge bg-success">
                        Available: <span class="fw-bolder">12</span>
                    </span>
                    <span class="badge bg-danger">
                        Sold: <span class="fw-bolder">5</span>
                    </span>
                </div>
            </div>

            <!-- Filter Button -->
            <button class="btn btn-outline-secondary text-bg-danger" type="button" data-bs-toggle="modal"
                data-bs-target="#filterModal">
                <i class="ph-bold ph-faders me-2"></i>Apply Filters
            </button>
        </div>

        <!-- Filter Modal - Provides advanced search and filtering options for vehicles by various criteria -->
        <div class="modal fade" id="filterModal" tabindex="-1" aria-labelledby="filterModalLabel" aria-hidden="true">
            <div class="modal-dialog modal-lg modal-dialog-scrollable">
                <div class="modal-content">

                    <div class="modal-header">
                        <h5 class="modal-title fw-bold text-uppercase text-secondary" id="filterModalLabel">
                            <i class="ph-bold ph-faders me-2 text-danger"></i>Search Filters
                        </h5>
                    ...
                    <div class="modal-body">
                        <div class="row g-3">
                            ...
                            <div class="col-12 col-md-6 col-lg-4">
                                ...
                                <input type="text" class="form-control border" placeholder="Name, Bike, Engine...">
                            </div>

                            <div class="col-6 col-md-3 col-lg-2">
                                <label class="form-label small text-muted fw-bold">Vehicle No.</label>
                                <input type="text" class="form-control border" placeholder="WB 00 AA 0000">
                            </div>
                            ...
                            <div class="col-6 col-md-3 col-lg-2">
                                ...
                                <select class="form-select border small">
                            ...
                            <div class="col-6 col-md-3 col-lg-2">
                                ...
                                <select class="form-select border small">
                                    <option>All</option>
                                    <option class="fw-bold text-success">Available</option>
                                    <option class="fw-bold text-danger">Sold</option>
                                </select>
                            </div>
                            ...
                            <div class="col-6 col-md-4 col-lg-2">
                                ...
                                <input type="text" class="form-control border" placeholder="Bike Model">
                            </div>

                            <div class="col-6 col-md-4 col-lg-2">
                                <label class="form-label small text-muted fw-bold">Engine No.</label>
                                <input type="text" class="form-control border" placeholder="Engine No">
                            </div>

                            <div class="col-6 col-md-6 col-lg-2">
                                <label class="form-label small text-muted fw-bold">Chassis No.</label>
                                <input type="text" class="form-control border" placeholder="Chassis No">
                            </div>
        ...
        <div class="position-relative" style="min-height: 400px;">
            <div class="row row-cols-1 row-cols-md-2 row-cols-lg-3 g-4">
                ...
                <!-- CARD 1 (Available) -->
                <div class="col">
                    <div class="card h-100 bg-white rounded-4 overflow-hidden inventory-card">
                        <div class="position-relative">
                            <!-- 4:3 Ratio for Medium look -->
                            <div style="width:100%; height:150px;" class="overflow-hidden rounded">
                            ...
                            <div class="position-absolute top-0 end-0 p-3">
                                <span
                                    class="badge bg-white text-success border border-success-subtle shadow-sm rounded-pill px-3 py-2 fw-bold">
                                    <i class="ph-fill ph-circle me-1"
                                        style="font-size: 8px; vertical-align: middle;"></i> AVAILABLE
                                </span>
                            </div>
                        </div>
                        <div class="card-body p-4 d-flex flex-column">
                            <div class="mb-3">
                                <h5 class="card-title fw-bold text-dark mb-1">WB 20 AB 1234</h5>
                                <p class="card-text text-secondary fw-medium small">Hero Splendor Plus</p>
                            </div>

                            <div class="d-flex gap-2 mb-4">
                                <span class="badge bg-light text-dark border fw-medium px-3 py-2 rounded-pill">
                                    <i class="ph-bold ph-calendar-blank me-1 text-muted"></i> 2023
                                </span>
                                <span class="badge bg-light text-dark border fw-medium px-3 py-2 rounded-pill">
                                    <i class="ph-bold ph-user me-1 text-muted"></i> 1st Owner
                                </span>
                            </div>
                            ...
                            <div class="mt-auto pt-3 border-top d-flex justify-content-between align-items-center">
                                <div>
                                    <small class="text-uppercase text-muted fw-bold"
                                        style="font-size: 10px;">Price</small>
                                    <div class="fs-4 fw-bold text-dark">₹75,000</div>
                                </div>
                                <div class="d-flex gap-2">
                                    <button class="btn btn-white border border-dark fw-bold rounded-pill px-4"
                                        onclick="openModal('dealModal')">
                                        <i class="ph-bold ph-pencil-simple text-dark"></i>
                                    </button>
                ...
                <div class="col">
                    <div class="card h-100 bg-white rounded-4 overflow-hidden inventory-card">
                        <div class="position-relative">
                            ...
                            <!-- 4:3 Ratio for Medium look -->
                            <div style="width:100%; height:150px;" class="overflow-hidden rounded">
                                <img src="https://www.carandbike.com/_next/image?url=https%3A%2F%2Fimages.carandbike.com%2Fcms%2Farticles%2F3201199%2FRoyal_Enfield_Hunter_350_1_2022_08_05_T03_41_40_503_Z_6ab6dc0960.png&w=1600&q=75"
                                    class="w-100 h-100 object-fit-cover" alt="Car">
                            </div>
                            ...
                            <div class="position-absolute top-0 end-0 p-3">
                                <span
                                    class="badge bg-white text-danger border border-danger shadow-sm rounded-pill px-3 py-2 fw-bold">
                                    <i class="ph-bold ph-x-circle me-1" style="font-size: 10px;"></i> SOLD OUT
                                </span>
                            </div>
                        ...
                        <div class="card-body p-4 d-flex flex-column">
                            <div class="mb-3">
                                <h5 class="card-title fw-bold text-dark mb-1">WB 12 XY 9876</h5>
                                <p class="card-text text-secondary fw-medium small">TVS Apache RTR 160</p>
                            </div>

                            <div class="d-flex gap-2 mb-4">
                                <span class="badge bg-light text-dark border fw-medium px-3 py-2 rounded-pill">
                                    <i class="ph-bold ph-calendar-blank me-1 text-muted"></i> 2021
                                </span>
                                <span class="badge bg-light text-dark border fw-medium px-3 py-2 rounded-pill">
                                    <i class="ph-bold ph-user me-1 text-muted"></i> 2nd Owner
                                </span>
                            </div>
                            ...
                            <div class="mt-auto pt-3 border-top d-flex justify-content-between align-items-center">
                                <div>
                                    <small class="text-uppercase text-muted fw-bold"
                                        style="font-size: 10px;">Price</small>
                                    <div class="fs-4 fw-bold text-dark">₹58,000</div>
                                </div>
                    ...
                    <div class="modal-content rounded-5 border-0 shadow-lg overflow-hidden">
                        ...
                        <div class="modal-header border-bottom bg-white px-4 py-3 sticky-top z-3">
                            <div class="d-flex align-items-center gap-3 w-100">
                                <div class="bg-light p-2 rounded-circle shadow-sm border text-primary">
                                    <i class="ph-fill ph-car-profile fs-4"></i>
                                </div>
                                <div class="lh-1">
                                ...
                                <div class="accordion-item rounded-4 shadow-sm border-0 mb-3 overflow-hidden">
                                    <h2 class="accordion-header">
                                        <button class="accordion-button fw-bold text-uppercase text-dark py-3"
                                            type="button" data-bs-toggle="collapse" data-bs-target="#collapseVehicle">
                                            ...
                                            <div class="p-3 bg-light rounded-4 border mb-3">
                                                <div class="row g-3">
                                                    ...
                                                    <div class="col-12 col-md-12">
                                                        ...
                                                        <div class="fw-bold text-dark font-monospace">ME3J5F5F9LC01234
                                                        </div>
                                                    </div>
                                                    <div class="col-12 col-md-12">
                                                        <small class="text-muted text-uppercase fw-bold"
                                            ...
                                            <div class="d-flex justify-content-between align-items-center mb-4">
                                                <div>
                                                    ...
                                                    <div class="fw-bold text-primary"><i
                                                            class="ph-bold ph-google-logo me-1"></i> Google Pay</div>
                                                </div>
                                                <div class="text-end">
                                        ...
                                        <div class="accordion-body bg-white p-4 border-top">
                                            ...
                                            <div class="row g-2 mb-3">
                                                ...
                                                <div class="col-12">
                                                    <small class="text-muted fw-bold" style="font-size:10px;">CHASSIS
                                                        NO</small>
                                                    <div class="fw-bold text-dark font-monospace small">MD2A123...</div>
                                                </div>
                                                <div class="col-12">
                                                    <small class="text-muted fw-bold" style="font-size:10px;">ENGINE
                                                        NO</small>
                                                    <div class="fw-bold text-dark font-monospace small">DHK88...</div>
                                                </div>
                                            </div>
                                            ...
                                            <div class="bg-light p-3 rounded-3 mb-3 border">
                                                ...
                                                <div class="d-flex gap-3 flex-wrap">
                                                    <span class="badge bg-white text-dark border"><i
                                                            class="ph-fill ph-phone"></i> 9876543210</span>
                                                    <span class="badge bg-white text-dark border"><i
                                                            class="ph-fill ph-phone"></i> 8765432109</span>
                                                    <span
                                                        class="badge bg-white text-dark border text-muted opacity-50"><i
                                                            class="ph-fill ph-phone"></i> --</span>
                                                </div>
                                            </div>
                                            ...
                                            <div class="bg-light border rounded-4 p-3 mb-3">
                                                ...
                                                <div class="d-flex text-center border rounded overflow-hidden bg-white">
                                                    ...
                                                    <div
                                                        class="flex-fill p-2 border-end bg-success-subtle text-success">
                                    ...
                                    <div id="collapseBuyer" class="accordion-collapse collapse"
                                        ...
                                        <div class="accordion-body bg-white p-4 border-top">
                                            ...
                                            <div class="p-3 border rounded-4 bg-light mb-4 position-relative">
                                                <span
                                                    class="position-absolute top-0 start-50 translate-middle badge bg-dark text-white border-light border">Insurance
                                                    Details</span>
                                                <div class="row g-2 mt-1">
                                                    <div class="col-12">
                                                        <div class="d-flex justify-content-between">
                                                            <span class="small text-muted">Provider:</span>
                                                            <span class="fw-bold">ICICI Lombard</span>
                                                        </div>
                                                    </div>
                                                    <div class="col-12">
                                                        <div class="d-flex justify-content-between">
                                                    ...
                                                    <div class="col-12">
                                                        <div class="d-flex justify-content-between">
                                                            ...
                                                            <span class="fw-bold text-danger">2026-11-25</span>
                                                        </div>
                                                    </div>
                                                </div>
                                            </div>
                                            ...
                                            <div class="alert alert-primary border-primary mb-3">
                                                ...
                                                <div class="row g-2">
                                                    ...
                                                    <div class="col-12 mt-2 pt-2 border-top border-primary-subtle">
                                                        ...
                                                        <div class="gap-2">
                                                            <span
                                                                class="badge bg-white text-dark border">9988776655</span>
                                                            <span
                                                                class="badge bg-white text-dark border">8877665544</span>
                                                            <span
                                                                class="badge bg-white text-muted border text-decoration-line-through">--</span>
                                                        </div>
                                                    </div>
                                                </div>
                                            </div>
                                            ...
                                            <!-- Price Breakdown -->
                                            <div
                                                class="d-flex text-center border rounded overflow-hidden bg-white mb-3">
                                                <div class="flex-fill p-2 border-end">
                                                    <div class="small text-muted fw-bold" style="font-size:10px">TOTAL
                                                    </div>
                                ...
                                <div class="accordion-item rounded-4 shadow-sm border-0 mb-3 overflow-hidden">
                                    ...
                                    <div id="collapseTransfer" class="accordion-collapse collapse"
                                        ...
                                        <div class="accordion-body bg-white p-4 border-top">
                                            ...
                                            <div class="border rounded-4 overflow-hidden mb-4">
                                                <div class="bg-light px-3 py-2 border-bottom">
                                                    <h6 class="fw-bold mb-0 small text-uppercase">Vendor Payment Details
                                                    </h6>
                                                </div>
                                                <table class="table table-sm align-middle mb-0 text-center">
                                                    <thead>
                                            ...
                                            <div class="bg-light p-3 rounded-3 border mb-4">
                                                <h6 class="fw-bold small mb-2">Insurance (Transfer)</h6>
                                                <div class="d-flex justify-content-between mb-1">
                                                    <span class="small text-muted">Name:</span>
                                                    <span class="fw-bold small">Bajaj Allianz</span>
                                                </div>
                                                <div class="d-flex justify-content-between mb-1">
                                                    <span class="small text-muted">Policy:</span>
                                                    <span class="fw-bold font-monospace small">OG-23-9901-1801</span>
                                                </div>
                                                <div class="d-flex justify-content-between">
                                                    <span class="small text-muted">Expiry:</span>
                                                    <span class="fw-bold text-dark small">2024-12-31</span>
                                                </div>
                                            </div>
                                            ...
                                            <div class="row g-2">
                                                <div class="col-6">
                                                    <div class="p-3 border rounded-3 text-center bg-light h-100">
                                                        ...
                                                        <div class="small text-muted" style="font-size:10px">2025-11-26
                                                        </div>
                                                    </div>
                                                </div>
                                                <div class="col-6">
                                ...
                                <div>
                                    ...
                                    <div class="row g-3 mb-3">
                                        ...
                                        <div class="col-12 col-md-6"><label>Register Date</label><input type="date"
                                                class="form-control" value="2025-11-26"></div>
                        ...
                        <div id="step-3" class="wizard-step d-none">
                            <div class="card steps-id border-0 p-4 shadow-sm rounded-4">
                                ...
                                <div class="bg-light p-3 rounded-4 border mb-4">
                                    <label class="text-dark mb-3 d-block">Buyer Payment</label>
                                ...
                                <div class="row g-2 align-items-end mb-3">
                                    <div class="col-12 col-md-6">
                                        ...
                                        <input type="text" class="form-control" placeholder="Insurance Name" required>
                                    </div>

                                    <div class="col-12 col-md-6">
                                        <label class="fw-bold">Policy No</label>
                                        <input type="text" class="form-control" placeholder="Policy No" required>
                                    </div>

                                    <div class="col-12 col-md-6">
                                        <label class="fw-bold">Insurance Expiry Date</label>
