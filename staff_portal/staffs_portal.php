...
<body>
        ...
        <div class="container">
            ...
            <div class="collapse navbar-collapse" id="navbarNav">
                <ul class="navbar-nav ms-auto gap-3 align-items-center">
                    <li class="nav-item"><a class="nav-link fw-medium text-dark" href="staffs_portal.php">Home</a></li>
        ...
        <div class="container py-5">
            <div class="row g-5 align-items-center">
                ...
                <div class="col-lg-6 text-center text-lg-start order-2 order-lg-1">
                    <div class="badge bg-white border text-dark mb-3 px-3 py-2 rounded-pill fw-bold shadow-sm">
                        <i class="fa-solid fa-check-circle text-success me-1"></i> 100% Verified Paperwork
                    </div>

                    <h1 class="fw-bold mb-3 display-5 display-md-4">
                        Upgrade your ride,<br>hassle-free.
                    </h1>

                    <p class="lead text-secondary mb-4">
                        Discover the finest collection of pre-owned bikes and scooters in Belatore.
                        Certified, serviced & ready for the road.
                    </p>

                    <div
                        class="d-flex gap-4 text-secondary small fw-bold justify-content-center justify-content-lg-start">
                        <span><i class="fa-solid fa-star text-warning me-1"></i> 4.8/5 Rating</span>
                        <span><i class="fa-solid fa-users text-primary me-1"></i> 500+ Happy Customers</span>
                    </div>
                </div>
                ...
                <div class="col-lg-6 text-center order-1 order-lg-2">
                    ...
                    <!-- Circle using responsive sizes -->
                    <div class="mx-auto rounded-circle overflow-hidden shadow-lg
                            d-flex justify-content-center align-items-center
                            bg-light
                            w-75 w-md-50 w-lg-75" style="aspect-ratio: 1;">

                        <div id="heroCircleSlider" class="carousel slide w-100 h-100" data-bs-ride="carousel">
                            ...
                            <!-- Controls -->
                            <button class="carousel-control-prev" type="button" data-bs-target="#heroCircleSlider"
                                data-bs-slide="prev">
                                <span class="carousel-control-prev-icon"></span>
                            </button>

                            <button class="carousel-control-next" type="button" data-bs-target="#heroCircleSlider"
                                data-bs-slide="next">
    ...
    <section class="inventory-header" id="inventory">
        <div class="container text-center">
            <h1 class="fw-black mb-4 display-5" style="font-weight: 800; letter-spacing: -1px;">Browse Inventory</h1>

            <div class="hero-search-container mb-4 mx-auto">
            ...
            <div class="d-flex justify-content-center gap-2 flex-wrap">
                ...
                <div class="filter-chip"><i class="fa-solid fa-motorcycle"></i> Bikes</div>
                <div class="filter-chip"><i class="ri-e-bike-2-fill"></i> Scooters</div>
            </div>

            <p class="text-muted mt-3 small fw-bold">Showing 2 Vehicles</p>
        </div>
    </section>
                        ...
                        <div class="p-4 pt-3">
                            <div class="d-flex justify-content-between align-items-center mb-2">
                                <small class="text-secondary fw-bold text-uppercase"
                                    style="font-size: 0.7rem;">Commuter</small>
                            ...
                            <div class="d-flex gap-2 mb-3">
                                <span class="spec-chip">2023</span>
                ...
                <nav aria-label="Page navigation">
                    <ul class="pagination">
                        <li class="page-item disabled"><a
                                class="page-link rounded-start-pill border-0 bg-light text-muted" href="#">Prev</a></li>
                        <li class="page-item active"><a class="page-link border-0 bg-black text-white" href="#">1</a>
                        </li>
                        ...
                        <li class="page-item"><a class="page-link rounded-end-pill border-0 text-dark" href="#">Next</a>
                        </li>
                    </ul>
                </nav>
            </div>
                                ...
                                <div class="accordion-body bg-white p-4 border-top">
                                    ...
                                    <div class="bg-light p-3 rounded-3 mb-3 border">
                                        ...
                                        <div class="d-flex gap-3 flex-wrap">
                                            ...
                                            <span class="badge bg-white text-dark border text-muted opacity-50"><i
                                    ...
                                    <div class="alert alert-primary border-primary mb-3">
                                        ...
                                        <div class="row g-2">
                                            ...
                                            <div class="col-12 mt-2 pt-2 border-top border-primary-subtle">
                                                ...
                                                <div class="gap-2">
                                                    <span class="badge bg-white text-dark border">9988776655</span>
                                                    <span class="badge bg-white text-dark border">8877665544</span>
                                                    <span
                                    ...
                                    <div class="row g-2">
                                        <div class="col-6 col-md-3">
                                            <div class="border rounded p-2 text-center bg-light">
                                                <small class="d-block fw-bold mb-1" style="font-size:10px">AADHAR
                                                    FRONT</small>
            ...
            <div class="row g-5">
                ...
                <div class="col-lg-3">
                    ...
                    <div class="d-flex gap-3">
                        ...
                        <div>
                            <span class="fw-bold small d-block">Call Us</span>
